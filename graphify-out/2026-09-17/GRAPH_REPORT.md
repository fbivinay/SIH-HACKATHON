...
## Corpus Check
- 101 files · ~869,241 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1009 nodes · 1586 edges · 89 communities (53 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e6af3f1`
...
### Community 10 - "api.ts"
Cohesion: 0.10
Nodes (21): LABELS, ReviewTrail(), when(), AgencyStat, AlertPage, api, ComplianceBook, ComplianceRule (+13 more)
...
### Community 13 - "map/page.tsx"
Cohesion: 0.23
Nodes (10): react-leaflet, GeoJSON, MapContainer, MapPage(), TileLayer, StateStat, CHOROPLETH_STEPS, choroplethFill() (+2 more)
...
Cohesion: 0.29
Nodes (8): ProjectsPage(), Pager(), ProjectFilters(), handleQChange(), updateParams(), STATUS_OPTION_LABELS, FilterOptions, formatCount()
...
### Community 80 - "format.ts"
Cohesion: 0.33
Nodes (8): methodFor(), ProjectPage(), DUPLICATE_SIMILARITY_THRESHOLD, hasPeers(), isNearDuplicate(), MIN_PEERS_FOR_COST, RiskLevel, workStatusLabel()
...
### Community 88 - "riskLevelLabel"
Cohesion: 0.21
Nodes (14): AnalysisPage(), DistrictDeskPage(), Params, Search, MpPage(), CountUp(), easeOut(), DistrictDesk (+6 more)
...
- **Should `load_real_data.py` be split into smaller, more focused modules?**
