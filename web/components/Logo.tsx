...
/**
 * The mark: the touchstone under a magnifying glass, ringed in the tricolour.
 *
 ...
 *
 * A raster (`public/logo.png`, 512px, transparent outside the ring), so it is
 * the one piece of the interface that carries colour without meaning risk.
